...
<Header>
	{#snippet links()}
		<ul class="site_header">
			...
			<li style="--active-fill: var(--nord10)"><a href={resolve('/fitness/[history=fitnessHistory]', { history: s.history })} class:active={isActive(`/fitness/${s.history}`)}><Clock size={16} strokeWidth={1.5} class="nav-icon" /><span class="nav-label">{labels.history}</span></a></li>
