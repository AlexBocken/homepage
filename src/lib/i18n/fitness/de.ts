...
export const de = {
	...
	insight_regular_title: "Dein Zyklus wirkt regelmäßig",
	insight_regular_body: "Deine letzten Zyklen liegen im typischen Bereich von 21–35 Tagen und schwanken kaum. Ein regelmäßiger, vorhersehbarer Zyklus ist ein gutes Zeichen dafür, dass Hormone und Eisprung gut funktionieren – er gilt als „fünftes Vitalzeichen“. Weiter so!",
	insight_irregular_title: "Deine Zyklen schwanken stark",
	insight_irregular_body: "Deine letzten Zykluslängen schwanken um mehr als eine Woche. Gelegentliche Schwankungen sind normal, anhaltende Unregelmäßigkeit kann aber mit Stress, schlechtem Schlaf, starken Gewichtsveränderungen, Schilddrüsenproblemen oder PCOS zusammenhängen. Regelmäßiger Schlaf, Bewegung und Stressabbau können helfen. Halten die Unregelmäßigkeiten über mehrere Monate an, sprich mit einer Ärztin oder einem Arzt.",
	...
	insight_long_period_body: "Eine Blutung von mehr als sieben Tagen oder eine sehr starke Blutung kann den Eisenspiegel senken und müde machen und durch hormonelles Ungleichgewicht, Myome oder Polypen verursacht werden. Suche ärztlichen Rat, wenn du regelmäßig länger als sieben Tage blutest, stündlich Binde oder Tampon wechseln musst oder Klumpen größer als eine Münze abgehen.",
