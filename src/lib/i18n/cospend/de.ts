...
export const de = {
	...
	no_expenses_month: "Noch keine Ausgaben erfasst",
	no_expenses_month_hint: "Erfasse eine Zahlung, dann erscheint sie hier.",
	view_receipt: "Beleg ansehen",
	scan_reading: "Beleg wird gelesen…",
	scan_total_label: "Erkannter Betrag",
	scan_total_applied: "Betrag vom Beleg übernommen — bitte prüfen.",
	scan_no_total: "Kein Betrag erkannt. Bitte manuell eingeben.",
	scan_failed: "Beleg konnte nicht gescannt werden. Bitte manuell eingeben.",
	rescan: "Erneut scannen",
	pick_total_hint: "Falscher Betrag? Tippe die richtige Zahl an oder ziehe einen Rahmen darum.",
	pen_total: "Gesamt",
	assign_hint: "Tippe die Artikel einer Person an, um ihren persönlichen Anteil festzulegen; der Rest wird gleichmässig geteilt.",
	split_equally: "Gleichmässig geteilt",
	...
	split_desc_equal: "Alle zahlen den gleichen Anteil.",
	split_desc_personal: "Persönliches zuerst, der Rest gleichmässig geteilt.",
	split_full_title: "Für die andere Person",
	split_desc_full: "Die andere Person schuldet den ganzen Betrag.",
	owes_full: "schuldet den ganzen Betrag",
	split_desc_custom: "Anteil pro Person selbst festlegen.",
	paid_verb: "bezahlt",
	settled_up: "ausgeglichen",
