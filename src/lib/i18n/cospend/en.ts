...
export const en = {
	...
	no_expenses_month: "No expenses logged yet",
	no_expenses_month_hint: "Add a payment and it'll show up here.",
	view_receipt: "View receipt",
	scan_reading: "Reading receipt…",
	scan_total_label: "Detected total",
	scan_total_applied: "Amount filled in from the receipt — double-check it.",
	scan_no_total: "Couldn't read a total. Enter the amount manually.",
	scan_failed: "Couldn't scan the receipt. Enter the amount manually.",
	rescan: "Scan again",
	pick_total_hint: "Wrong total? Tap the right number, or drag a box around it.",
	pen_total: "Total",
	assign_hint: "Tap a person's items to set their personal share; the rest is split equally.",
	...
	split_desc_equal: "Everyone pays an equal share.",
	split_desc_personal: "Personal items first, the rest shared equally.",
	split_full_title: "Paid for the other",
	split_desc_full: "The other person owes the full amount.",
	owes_full: "owes the full amount",
	split_desc_custom: "Set each person's share by hand.",
	paid_verb: "paid",
