...
export const CATEGORY_ITEMS: CategoryItem[] = [
  ...
  // ── Süsses & Snacks ──
  { name: 'Schokolade', category: 'Süsses & Snacks' },
  { name: 'Chips', category: 'Süsses & Snacks' },
  { name: 'Gummibärchen', category: 'Süsses & Snacks' },
  { name: 'Kekse', category: 'Süsses & Snacks' },
  { name: 'Eis', category: 'Süsses & Snacks' },
  { name: 'Glacé', category: 'Süsses & Snacks' },
  { name: 'Glace', category: 'Süsses & Snacks' },
  { name: 'Nüsse', category: 'Süsses & Snacks' },
  { name: 'Erdnüsse', category: 'Süsses & Snacks' },
  { name: 'Mandeln', category: 'Süsses & Snacks' },
  { name: 'Kuchen', category: 'Süsses & Snacks' },
  { name: 'Bonbons', category: 'Süsses & Snacks' },
  { name: 'Müsliriegel', category: 'Süsses & Snacks' },
  { name: 'Popcorn', category: 'Süsses & Snacks' },
  { name: 'Salzstangen', category: 'Süsses & Snacks' },
  { name: 'Snickers', category: 'Süsses & Snacks' },
  { name: 'Mars', category: 'Süsses & Snacks' },
  { name: 'Twix', category: 'Süsses & Snacks' },
  { name: 'Haribo', category: 'Süsses & Snacks' },
  { name: 'Milka', category: 'Süsses & Snacks' },
  { name: 'Oreo', category: 'Süsses & Snacks' },
  { name: 'chocolate', category: 'Süsses & Snacks' },
  { name: 'chips', category: 'Süsses & Snacks' },
  { name: 'cookies', category: 'Süsses & Snacks' },
  { name: 'ice cream', category: 'Süsses & Snacks' },
  { name: 'nuts', category: 'Süsses & Snacks' },

  // ── Konserven ──
  { name: 'Dosentomaten', category: 'Konserven' },
  { name: 'Gehackte Tomaten (Dose)', category: 'Konserven' },
  { name: 'Dosenmais', category: 'Konserven' },
  { name: 'Kidneybohnen', category: 'Konserven' },
  { name: 'Kichererbsen aus der Dose', category: 'Konserven' },
  { name: 'Heinz Beans', category: 'Konserven' },
  { name: 'Baked Beans', category: 'Konserven' },
  { name: 'Weisse Bohnen (Dose)', category: 'Konserven' },
  { name: 'Dosenravioli', category: 'Konserven' },
  { name: 'Dosensuppe', category: 'Konserven' },
  { name: 'Thunfisch in der Dose', category: 'Konserven' },
  { name: 'Sardinen', category: 'Konserven' },
  { name: 'Kokosmilch', category: 'Konserven' },
  { name: 'Dosenananas', category: 'Konserven' },
  { name: 'Dosenpfirsiche', category: 'Konserven' },
  { name: 'Oliven', category: 'Konserven' },
  { name: 'Essiggurken', category: 'Konserven' },
  { name: 'Sauerkraut (Glas)', category: 'Konserven' },
  { name: 'Konserven', category: 'Konserven' },
  { name: 'canned tomatoes', category: 'Konserven' },
  { name: 'canned corn', category: 'Konserven' },
  { name: 'kidney beans', category: 'Konserven' },
  { name: 'canned chickpeas', category: 'Konserven' },
  { name: 'baked beans', category: 'Konserven' },
  { name: 'canned ravioli', category: 'Konserven' },
  { name: 'canned soup', category: 'Konserven' },
  { name: 'canned tuna', category: 'Konserven' },
  { name: 'sardines', category: 'Konserven' },
  { name: 'coconut milk', category: 'Konserven' },
  { name: 'canned pineapple', category: 'Konserven' },
  { name: 'olives', category: 'Konserven' },
  { name: 'pickles', category: 'Konserven' },
  { name: 'canned food', category: 'Konserven' },
