...
for (const name of [...names].sort()) {
  ...
  if (d) {
    out[name] = keepOuter(d);
    traced++;
  }
  process.stdout.write('.');
}

const body = `// AUTO-GENERATED by scripts/trace-sticker-silhouettes.mjs — do not edit by hand.
export const SIL_SIZE = ${SIZE};
/** @type {Record<string, string>} */
export const SILHOUETTES = ${JSON.stringify(out)};
`;
writeFileSync(join(root, 'src/lib/data/stickerSilhouettes.js'), body);
console.log(`\ntraced ${traced}/${names.size} stickers → src/lib/data/stickerSilhouettes.js`);
